...
"matrix_width" : the length of the embedding before passing into actor or critic 
...
class SumChars(nn.Module):
    def __init__(self, obs_size: int, word_list: List[str], n_hidden: int = 1, hidden_size: int = 256, embedding_matrix = "original", matrix_width = 26*5, num_actor_layers = 1, num_critic_layers = 1, glove_dataset = "common_crawl_840", glove_demb = 300):
        """
        Args:
